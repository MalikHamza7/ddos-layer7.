...
#This Tool Created by Malik Hamza
...
class fucker(threading.Thread):
    ...
    def request(self):
        ...
        print("[Anonymous Sudan AKA Malik Hamza] Neutralizing The Traget [%s]\r"%(self.url))
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                sys.stdout.write("[Anonymous Sudan AKA Malik Hamza] Neutralizing The Traget [%s]\r"%(self.url))
                sys.exit(0)
        sys.exit(0)
...
Anonymous Sudan Attack
              DDoS Tool Layer7 Written By Malik Hamza                                       
""")
        try:
            url = sys.argv[1]
